    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-lg flex-1 px-4 py-12 sm:px-6">
        ...
        <p className="mt-1 text-sm leading-relaxed text-muted">
          Import an Octavo export (.zip), a folder of Markdown as a .zip, or a
          single .md file. Wiki.js, BookStack, Obsidian, and MkDocs exports are
          all Markdown underneath — they land here cleanly. Imports arrive as a
          private space.
        </p>
        {error && (
